...
var _ resource.Resource = &VanillaConnectionResource{}
var _ resource.ResourceWithImportState = &VanillaConnectionResource{}

func (t *VanillaConnectionResource) GetSchema(ctx context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (r *VanillaConnectionResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	created, err := r.client.Connections().Create(ctx,
		polytomic.CreateConnectionMutation{
			...
			Configuration: polytomic.VanillaConnectionConfiguration{
	...
	//var output polytomic.VanillaConnectionConfiguration
	...
	tflog.Trace(ctx, "created a connection", map[string]interface{}{"type": "Vanilla", "id": created.ID})
