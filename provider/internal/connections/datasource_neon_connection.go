...
var _ datasource.DataSource = &NeonConnectionDataSource{}

// ExampleDataSource defines the data source implementation.
type NeonConnectionDataSource struct {
	provider *providerclient.Provider
}

func (d *NeonConnectionDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
	if provider := providerclient.GetProvider(req.ProviderData, resp.Diagnostics); provider != nil {
		d.provider = provider
	}
}

func (d *NeonConnectionDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_neon_connection"
}

func (d *NeonConnectionDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
type NeonDataSourceConf struct {
...
func (d *NeonConnectionDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
