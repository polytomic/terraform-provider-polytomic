...
var _ datasource.DataSource = &TigrisConnectionDataSource{}

// ExampleDataSource defines the data source implementation.
type TigrisConnectionDataSource struct {
	provider *providerclient.Provider
}

func (d *TigrisConnectionDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
	if provider := providerclient.GetProvider(req.ProviderData, resp.Diagnostics); provider != nil {
		d.provider = provider
	}
}

func (d *TigrisConnectionDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_tigris_connection"
}

func (d *TigrisConnectionDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
type TigrisDataSourceConf struct {
...
func (d *TigrisConnectionDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
