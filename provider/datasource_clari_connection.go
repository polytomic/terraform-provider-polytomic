...
var _ datasource.DataSource = &ClariConnectionDataSource{}
...
func (d *ClariConnectionDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	data.Configuration, diags = types.ObjectValue(
		...
		map[string]attr.Value{
			...
			"api_password": types.StringValue(
				getValueOrEmpty(connection.Data.Configuration["api_password"], "string").(string),
			),
		},
	)
