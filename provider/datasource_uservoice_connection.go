...
var _ datasource.DataSource = &UservoiceConnectionDataSource{}
...
func (d *UservoiceConnectionDataSource) GetSchema(ctx context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (d *UservoiceConnectionDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	var conf polytomic.UserVoiceConnectionConfiguration
