...
var _ datasource.DataSource = &ZendeskConnectionDataSource{}
...
func (d *ZendeskConnectionDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_zendesk_connection"
}

func (d *ZendeskConnectionDataSource) GetSchema(ctx context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
		MarkdownDescription: ":meta:subcategory:Connections: Zendesk Connection",
...
func (d *ZendeskConnectionDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	var conf polytomic.ZendeskConnectionConfiguration
