...
var _ datasource.DataSource = &SurvicateConnectionDataSource{}
...
func (d *SurvicateConnectionDataSource) GetSchema(ctx context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
