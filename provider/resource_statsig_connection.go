...
var _ resource.Resource = &StatsigConnectionResource{}
var _ resource.ResourceWithImportState = &StatsigConnectionResource{}

func (t *StatsigConnectionResource) GetSchema(ctx context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
		MarkdownDescription: ":meta:subcategory:Connections: Statsig Connection",
...
func (r *StatsigConnectionResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_statsig_connection"
}
...
func (r *StatsigConnectionResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	created, err := r.client.Connections().Create(ctx,
		polytomic.CreateConnectionMutation{
			...
			Configuration: polytomic.StatsigConnectionConfiguration{
	...
	//var output polytomic.StatsigConnectionConfiguration
	...
	tflog.Trace(ctx, "created a connection", map[string]interface{}{"type": "Statsig", "id": created.ID})
