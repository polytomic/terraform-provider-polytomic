...
var _ resource.Resource = &SurvicateConnectionResource{}
var _ resource.ResourceWithImportState = &SurvicateConnectionResource{}

func (t *SurvicateConnectionResource) GetSchema(ctx context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
		MarkdownDescription: ":meta:subcategory:Connections: Survicate Connection",
...
func (r *SurvicateConnectionResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_survicate_connection"
}
...
func (r *SurvicateConnectionResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	created, err := r.client.Connections().Create(ctx,
		polytomic.CreateConnectionMutation{
			...
			Configuration: polytomic.SurvicateConnectionConfiguration{
	...
	//var output polytomic.SurvicateConnectionConfiguration
	...
	tflog.Trace(ctx, "created a connection", map[string]interface{}{"type": "Survicate", "id": created.ID})
