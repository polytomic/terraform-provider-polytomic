...
func (r *SegmentConnectionResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	created, err := r.client.Connections().Create(ctx,
		polytomic.CreateConnectionMutation{
			...
			Configuration: polytomic.SegmentConnectionConfiguration{
	...
	//var output polytomic.SegmentConnectionConfiguration
	...
	tflog.Trace(ctx, "created a connection", map[string]interface{}{"type": "Segment", "id": created.ID})
