...
var _ resource.Resource = &AscendConnectionResource{}
var _ resource.ResourceWithImportState = &AscendConnectionResource{}

func (t *AscendConnectionResource) GetSchema(ctx context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
		MarkdownDescription: ":meta:subcategory:Connections: Ascend Connection",
...
func (r *AscendConnectionResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_ascend_connection"
}
...
func (r *AscendConnectionResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	created, err := r.client.Connections().Create(ctx,
		polytomic.CreateConnectionMutation{
			...
			Configuration: polytomic.AscendConnectionConfiguration{
	...
	//var output polytomic.AscendConnectionConfiguration
	...
	tflog.Trace(ctx, "created a connection", map[string]interface{}{"type": "Ascend", "id": created.ID})
