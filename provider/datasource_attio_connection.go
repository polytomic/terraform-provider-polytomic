...
func (d *AttioConnectionDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	data.Configuration, diags = types.ObjectValue(
		...
		map[string]attr.Value{
			"workspace_id": types.StringValue(
				getValueOrEmpty(connection.Data.Configuration["workspace_id"], "string").(string),
			),
			"workspace_slug": types.StringValue(
				getValueOrEmpty(connection.Data.Configuration["workspace_slug"], "string").(string),
			),
