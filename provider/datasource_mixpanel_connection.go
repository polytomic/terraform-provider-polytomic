...
var _ datasource.DataSource = &MixpanelConnectionDataSource{}
...
func (d *MixpanelConnectionDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	data.Configuration, diags = types.ObjectValue(
		...
		map[string]attr.Value{
			...
			"project_id": types.Int64Value(
				getValueOrEmpty(connection.Data.Configuration["project_id"], "int64").(int64),
			),
		},
	)
