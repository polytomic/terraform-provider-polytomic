...
require (
	...
	github.com/polytomic/polytomic-go v1.11.0
...
replace github.com/hashicorp/terraform-plugin-framework => github.com/polytomic/terraform-plugin-framework v1.13.1
