...
require (
	...
	github.com/polytomic/polytomic-go/v25 v25.9.4
...
replace github.com/hashicorp/terraform-plugin-framework => github.com/polytomic/terraform-plugin-framework v1.19.0
