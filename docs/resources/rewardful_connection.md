...
For detailed configuration guidance, see the [Rewardful connection guide](https://apidocs.polytomic.com/guides/configuring-your-connections/connections/rewardful).
...
- `id` (String, Read-only) Rewardful Connection identifier.
