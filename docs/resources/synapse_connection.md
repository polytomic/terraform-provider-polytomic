...
For detailed configuration guidance, see the [Azure Synapse connection guide](https://apidocs.polytomic.com/guides/configuring-your-connections/connections/synapse).
...
- `id` (String, Read-only) Azure Synapse Connection identifier.
