...
For detailed configuration guidance, see the [Airtable connection guide](https://apidocs.polytomic.com/guides/configuring-your-connections/connections/airtable).
...
- `id` (String, Read-only) Airtable Connection identifier.
