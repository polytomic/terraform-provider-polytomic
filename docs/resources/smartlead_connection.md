...
For detailed configuration guidance, see the [Smartlead.ai connection guide](https://apidocs.polytomic.com/guides/configuring-your-connections/connections/smartlead).
...
- `id` (String, Read-only) Smartlead.ai Connection identifier.
