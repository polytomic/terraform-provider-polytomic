...
For detailed configuration guidance, see the [UpPromote connection guide](https://apidocs.polytomic.com/guides/configuring-your-connections/connections/uppromote).
...
- `id` (String, Read-only) UpPromote Connection identifier.
