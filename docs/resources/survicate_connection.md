...
For detailed configuration guidance, see the [Survicate connection guide](https://apidocs.polytomic.com/guides/configuring-your-connections/connections/survicate).
...
- `id` (String, Read-only) Survicate Connection identifier.
