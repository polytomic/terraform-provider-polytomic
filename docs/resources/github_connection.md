...
For detailed configuration guidance, see the [GitHub connection guide](https://apidocs.polytomic.com/guides/configuring-your-connections/connections/github).
...
- `id` (String, Read-only) GitHub Connection identifier.
...
- `repositories` (Attributes Set, Optional) See [below for nested schema](#nestedatt--configuration--repositories).
