...
For detailed configuration guidance, see the [Recharge connection guide](https://apidocs.polytomic.com/guides/configuring-your-connections/connections/recharge).
...
- `id` (String, Read-only) Recharge Connection identifier.
