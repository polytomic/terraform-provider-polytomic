---
page_title: "polytomic_neon_connection Resource - terraform-provider-polytomic"
subcategory: "Connections"
description: |-
  Neon Connection
---

# polytomic_neon_connection (Resource)

Neon Connection

For detailed configuration guidance, see the [Neon connection guide](https://apidocs.polytomic.com/guides/configuring-your-connections/connections/neon).
...
- `id` (String) Neon Connection identifier.
