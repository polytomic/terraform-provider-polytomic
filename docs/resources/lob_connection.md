...
For detailed configuration guidance, see the [Lob connection guide](https://apidocs.polytomic.com/guides/configuring-your-connections/connections/lob).
...
- `id` (String, Read-only) Lob Connection identifier.
