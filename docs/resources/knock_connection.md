---
page_title: "polytomic_knock_connection Resource - terraform-provider-polytomic"
subcategory: "Connections"
description: |-
  Knock Connection
---

# polytomic_knock_connection (Resource)

Knock Connection

For detailed configuration guidance, see the [Knock connection guide](https://apidocs.polytomic.com/guides/configuring-your-connections/connections/knock).
...
- `id` (String) Knock Connection identifier.
