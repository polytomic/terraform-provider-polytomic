...
For detailed configuration guidance, see the [ShipBob connection guide](https://apidocs.polytomic.com/guides/configuring-your-connections/connections/shipbob).
...
- `id` (String, Read-only) ShipBob Connection identifier.
