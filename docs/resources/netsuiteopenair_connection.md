...
For detailed configuration guidance, see the [NetSuite OpenAir connection guide](https://apidocs.polytomic.com/guides/configuring-your-connections/connections/netsuiteopenair).
...
- `id` (String, Read-only) NetSuite OpenAir Connection identifier.
...
- `api_namespace` (String, Required) API Namespace
...
- `per_day_rate_limit` (Number, Required) Per Day Rate Limit
- `per_minute_rate_limit` (Number, Required) Per Minute Rate Limit
