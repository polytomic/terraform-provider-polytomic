...
For detailed configuration guidance, see the [PartnerPage connection guide](https://apidocs.polytomic.com/guides/configuring-your-connections/connections/partnerpage).
...
- `id` (String, Read-only) PartnerPage Connection identifier.
