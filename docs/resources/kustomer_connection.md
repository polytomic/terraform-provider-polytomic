...
For detailed configuration guidance, see the [Kustomer connection guide](https://apidocs.polytomic.com/guides/configuring-your-connections/connections/kustomer).
...
- `id` (String, Read-only) Kustomer Connection identifier.
...
- `domain` (String, Required) Customer Portal Subdomain
