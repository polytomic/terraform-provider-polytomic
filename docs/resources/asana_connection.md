...
For detailed configuration guidance, see the [Asana connection guide](https://apidocs.polytomic.com/guides/configuring-your-connections/connections/asana).
...
- `id` (String, Read-only) Asana Connection identifier.
