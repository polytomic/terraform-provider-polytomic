...
For detailed configuration guidance, see the [Salesbricks connection guide](https://apidocs.polytomic.com/guides/configuring-your-connections/connections/salesbricks).
...
- `id` (String, Read-only) Salesbricks Connection identifier.
