...
For detailed configuration guidance, see the [AWS OpenSearch connection guide](https://apidocs.polytomic.com/guides/configuring-your-connections/connections/awsopensearch).
...
- `id` (String, Read-only) AWS OpenSearch Connection identifier.
...
- `aws_secret_access_key` (String, Sensitive, Required) AWS Secret Access Key
- `aws_user` (String, Optional) User ARN
- `endpoint` (String, Required) Endpoint(s)
