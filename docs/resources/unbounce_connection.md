...
For detailed configuration guidance, see the [Unbounce connection guide](https://apidocs.polytomic.com/guides/configuring-your-connections/connections/unbounce).
...
- `id` (String, Read-only) Unbounce Connection identifier.
