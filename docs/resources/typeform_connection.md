...
For detailed configuration guidance, see the [Typeform connection guide](https://apidocs.polytomic.com/guides/configuring-your-connections/connections/typeform).
...
- `id` (String, Read-only) Typeform Connection identifier.
