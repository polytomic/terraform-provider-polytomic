...
For detailed configuration guidance, see the [AWS Athena connection guide](https://apidocs.polytomic.com/guides/configuring-your-connections/connections/awsathena).
...
- `id` (String, Read-only) AWS Athena Connection identifier.
...
- `access_id` (String, Optional) AWS Access ID
...
- `outputbucket` (String, Required) AWS S3 output bucket
...
- `tags` (Map of String, Optional) Additional tags to apply during role assumption
