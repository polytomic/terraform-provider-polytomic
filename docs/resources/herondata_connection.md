...
For detailed configuration guidance, see the [Heron Data connection guide](https://apidocs.polytomic.com/guides/configuring-your-connections/connections/herondata).
...
- `id` (String, Read-only) Heron Data Connection identifier.
