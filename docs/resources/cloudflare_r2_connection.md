...
For detailed configuration guidance, see the [Cloudflare R2 connection guide](https://apidocs.polytomic.com/guides/configuring-your-connections/connections/cloudflare_r2).
...
- `id` (String, Read-only) Cloudflare R2 Connection identifier.
