...
For detailed configuration guidance, see the [App Store Connect connection guide](https://apidocs.polytomic.com/guides/configuring-your-connections/connections/appstoreconnect).
