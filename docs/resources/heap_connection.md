...
For detailed configuration guidance, see the [Heap connection guide](https://apidocs.polytomic.com/guides/configuring-your-connections/connections/heap).
...
- `id` (String, Read-only) Heap Connection identifier.
