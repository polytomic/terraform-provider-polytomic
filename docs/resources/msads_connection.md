...
For detailed configuration guidance, see the [Microsoft Ads connection guide](https://apidocs.polytomic.com/guides/configuring-your-connections/connections/msads).
...
- `id` (String, Read-only) Microsoft Ads Connection identifier.
...
- `auth_method` (String, Optional) Authentication method Valid values: <code>microsoft</code> (Microsoft), <code>google</code> (Google). Default: <code>microsoft</code>.
...
- `username` (String, Optional) Connected user
