...
For detailed configuration guidance, see the [Google Cloud MySQL connection guide](https://apidocs.polytomic.com/guides/configuring-your-connections/connections/googlecloudmysql).
...
- `id` (String, Read-only) Google Cloud MySQL Connection identifier.
...
- `change_detection` (Boolean, Optional) Use replication for bulk syncs Default: <code>false</code>.
