...
For detailed configuration guidance, see the [QuickBooks connection guide](https://apidocs.polytomic.com/guides/configuring-your-connections/connections/quickbooks).
...
- `id` (String, Read-only) QuickBooks Connection identifier.
...
- `realm_id` (String, Required) Company ID
