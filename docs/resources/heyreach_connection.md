...
For detailed configuration guidance, see the [HeyReach connection guide](https://apidocs.polytomic.com/guides/configuring-your-connections/connections/heyreach).
...
- `id` (String, Read-only) HeyReach Connection identifier.
