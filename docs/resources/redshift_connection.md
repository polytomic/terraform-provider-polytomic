...
For detailed configuration guidance, see the [Redshift connection guide](https://apidocs.polytomic.com/guides/configuring-your-connections/connections/redshift).
...
- `id` (String, Read-only) Redshift Connection identifier.
...
- `port` (Number, Required) Default: <code>5439</code>.
