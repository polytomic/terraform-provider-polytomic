...
For detailed configuration guidance, see the [Scamalytics connection guide](https://apidocs.polytomic.com/guides/configuring-your-connections/connections/scamalytics).
...
- `id` (String, Read-only) Scamalytics Connection identifier.
...
- `endpoint` (String, Required) Enrichment Endpoint
