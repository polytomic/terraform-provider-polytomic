...
For detailed configuration guidance, see the [MailerCheck connection guide](https://apidocs.polytomic.com/guides/configuring-your-connections/connections/mailercheck).
...
- `id` (String, Read-only) MailerCheck Connection identifier.
