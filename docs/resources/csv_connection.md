...
For detailed configuration guidance, see the [CSV URL connection guide](https://apidocs.polytomic.com/guides/configuring-your-connections/connections/csv).
...
- `id` (String, Read-only) CSV URL Connection identifier.
