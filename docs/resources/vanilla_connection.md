...
For detailed configuration guidance, see the [Vanilla Forums connection guide](https://apidocs.polytomic.com/guides/configuring-your-connections/connections/vanilla).
...
- `id` (String, Read-only) Vanilla Forums Connection identifier.
