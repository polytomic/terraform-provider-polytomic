...
- `id` (String, Read-only) PostHog Connection identifier.
...
- `api_key` (String, Sensitive, Required) Personal API key
- `authenticated_as` (String, Optional) Connected as
- `location` (String, Required) Valid values: <code>us</code> (US), <code>eu</code> (EU). Default: <code>us</code>.
