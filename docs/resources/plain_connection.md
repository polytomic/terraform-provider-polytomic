...
For detailed configuration guidance, see the [Plain connection guide](https://apidocs.polytomic.com/guides/configuring-your-connections/connections/plain).
...
- `id` (String, Read-only) Plain Connection identifier.
