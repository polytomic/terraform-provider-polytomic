...
For detailed configuration guidance, see the [Barbour ABI connection guide](https://apidocs.polytomic.com/guides/configuring-your-connections/connections/barbourabi).
...
- `id` (String, Read-only) Barbour ABI Connection identifier.
