...
For detailed configuration guidance, see the [NetSuite connection guide](https://apidocs.polytomic.com/guides/configuring-your-connections/connections/netsuite).
...
- `id` (String, Read-only) NetSuite Connection identifier.
...
- `consumer_secret` (String, Sensitive, Required) Consumer Secret
- `token` (String, Required) Token ID
- `token_secret` (String, Sensitive, Required) Token Secret
