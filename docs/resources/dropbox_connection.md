...
For detailed configuration guidance, see the [Dropbox connection guide](https://apidocs.polytomic.com/guides/configuring-your-connections/connections/dropbox).
...
- `id` (String, Read-only) Dropbox Connection identifier.
...
- `app_key` (String, Sensitive, Optional)
- `app_secret` (String, Sensitive, Optional)
- `bucket` (String, Required) Folder
