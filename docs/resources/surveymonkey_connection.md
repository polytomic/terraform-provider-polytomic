...
For detailed configuration guidance, see the [SurveyMonkey connection guide](https://apidocs.polytomic.com/guides/configuring-your-connections/connections/surveymonkey).
...
- `id` (String, Read-only) SurveyMonkey Connection identifier.
