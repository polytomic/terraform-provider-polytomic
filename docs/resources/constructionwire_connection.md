...
For detailed configuration guidance, see the [ConstructionWire connection guide](https://apidocs.polytomic.com/guides/configuring-your-connections/connections/constructionwire).
...
- `id` (String, Read-only) ConstructionWire Connection identifier.
