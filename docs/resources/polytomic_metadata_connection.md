...
- `id` (String, Read-only) Polytomic Metadata Connection identifier.
...
- `connected_org` (String, Optional) Connected organization
- `connected_user` (String, Optional) Connected user
- `deployment_api_key` (String, Sensitive, Optional) Deployment API Key
- `partner_api_key` (String, Sensitive, Optional) Partner API Key

    Partner API key provided by Polytomic
- `personal_api_key` (String, Sensitive, Optional) Personal API Key
