...
- `external_id` (String) The external ID (UUID) to use when assuming the IAM role. If one is not provided, it will be generated by Polytomic on connection creation.
