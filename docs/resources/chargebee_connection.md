...
For detailed configuration guidance, see the [Chargebee connection guide](https://apidocs.polytomic.com/guides/configuring-your-connections/connections/chargebee).
