...
For detailed configuration guidance, see the [Reply connection guide](https://apidocs.polytomic.com/guides/configuring-your-connections/connections/replyio).
...
- `id` (String, Read-only) Reply Connection identifier.
