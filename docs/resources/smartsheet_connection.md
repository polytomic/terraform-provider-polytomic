...
For detailed configuration guidance, see the [Smartsheet connection guide](https://apidocs.polytomic.com/guides/configuring-your-connections/connections/smartsheet).
...
- `id` (String, Read-only) Smartsheet Connection identifier.
