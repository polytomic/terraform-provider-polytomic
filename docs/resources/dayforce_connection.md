...
For detailed configuration guidance, see the [Dayforce connection guide](https://apidocs.polytomic.com/guides/configuring-your-connections/connections/dayforce).
...
- `id` (String, Read-only) Dayforce Connection identifier.
