...
For detailed configuration guidance, see the [Outreach connection guide](https://apidocs.polytomic.com/guides/configuring-your-connections/connections/outreach).
...
- `id` (String, Read-only) Outreach Connection identifier.
...
- `use_bulk_upsert` (Boolean, Optional) Use bulk API for syncing to Outreach Default: <code>true</code>.
