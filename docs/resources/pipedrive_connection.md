...
For detailed configuration guidance, see the [Pipedrive connection guide](https://apidocs.polytomic.com/guides/configuring-your-connections/connections/pipedrive).
...
- `id` (String, Read-only) Pipedrive Connection identifier.
