...
For detailed configuration guidance, see the [Salesforce connection guide](https://apidocs.polytomic.com/guides/configuring-your-connections/connections/salesforce).
