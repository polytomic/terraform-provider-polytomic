...
For detailed configuration guidance, see the [Honeycomb connection guide](https://apidocs.polytomic.com/guides/configuring-your-connections/connections/honeycomb).
...
- `id` (String, Read-only) Honeycomb Connection identifier.
