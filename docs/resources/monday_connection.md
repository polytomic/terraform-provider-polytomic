...
For detailed configuration guidance, see the [monday.com connection guide](https://apidocs.polytomic.com/guides/configuring-your-connections/connections/monday).
...
- `id` (String, Read-only) monday.com Connection identifier.
