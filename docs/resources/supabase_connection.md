---
page_title: "polytomic_supabase_connection Resource - terraform-provider-polytomic"
subcategory: "Connections"
description: |-
  Supabase Connection
---

# polytomic_supabase_connection (Resource)

Supabase Connection

For detailed configuration guidance, see the [Supabase connection guide](https://apidocs.polytomic.com/guides/configuring-your-connections/connections/supabase).
...
- `id` (String) Supabase Connection identifier.
