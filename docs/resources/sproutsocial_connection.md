...
For detailed configuration guidance, see the [Sprout Social connection guide](https://apidocs.polytomic.com/guides/configuring-your-connections/connections/sproutsocial).
...
- `id` (String, Read-only) Sprout Social Connection identifier.
