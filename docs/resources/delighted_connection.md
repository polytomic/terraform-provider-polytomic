...
For detailed configuration guidance, see the [Delighted connection guide](https://apidocs.polytomic.com/guides/configuring-your-connections/connections/delighted).
...
- `id` (String, Read-only) Delighted Connection identifier.
