...
page_title: "polytomic_gatsby_connection Data Source - terraform-provider-polytomic"
subcategory: "Connections"
description: |-
  Gatsby Connection
---

# polytomic_gatsby_connection (Data Source)
...
```terraform
data "polytomic_gatsby_connection" "gatsby" {
