...
page_title: "polytomic_s3_compatible_connection Data Source - terraform-provider-polytomic"
subcategory: "Connections"
description: |-
  S3 Compatible Connection
---

# polytomic_s3_compatible_connection (Data Source)
...
```terraform
data "polytomic_s3_compatible_connection" "s3_compatible" {
