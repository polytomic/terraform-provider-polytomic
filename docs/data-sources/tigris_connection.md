...
page_title: "polytomic_tigris_connection Data Source - terraform-provider-polytomic"
subcategory: "Connections"
description: |-
  Tigris Connection
---

# polytomic_tigris_connection (Data Source)
...
```terraform
data "polytomic_tigris_connection" "tigris" {
